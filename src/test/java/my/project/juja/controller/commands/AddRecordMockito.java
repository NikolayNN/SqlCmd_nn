...
public class AddRecordMockito{
    ...
    public void testNormal() throws Exception {
        ...
        Mockito.when(store.getColumnInformation(tableName)).thenReturn(table.getCellInfos());
        String value1 = "1";
        String value2 = "Alex";
        String value3 = "Pupkin";
        String value4 = "root";
        Mockito.when(store.getConnectToDataBase()).thenReturn(connection);
        Mockito.when(view.read()).thenReturn(value1).thenReturn(value2).thenReturn(value3).thenReturn(value4);
        //when
        command.perform();
        //then
        ...
        row.getCell(3).setValue(value4, false);
        table.addRow(row);
